...
function loadCompare(){
    ...
    for (var i = 0; i < productArray.length; i++) {
		productName += '<th class="text-center ProductName">'+productArray[i].ProductName+'<a class="pull-right" onclick="deleteProduct(\''+productArray[i]._id+'\')" href="javascript:void(0)"><i class="fa fa-times" aria-hidden="true"></i></a></th>';
    	...
    	productDiscribe +='<td>'+productArray[i].Discribe+'</td>';
    };
