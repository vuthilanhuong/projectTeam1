	...
	$.ajax({
		...
		success: function(response){
			...
			for (var i = 0; i < 9; i++) {
				...
				content +=				'<a href="file:///Users/user/Desktop/Eyeonic-master/serverSide/product-details.html" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i><button onclick="clickCounter()" type="button">Thêm Vào Giỏ</button></a>';
				content +=			'</div>';
				content +=		'</div>';
				content +=	'</div>';
				content +='</div>';
